...
var (
	...
	ErrCannotAddTodo           = sdkerrors.Register(ModuleName, 1113, "cannot add todo: %s")
	ErrCannotGetTodo           = sdkerrors.Register(ModuleName, 1114, "cannot get todo: %s")
	ErrCannotGetAllTodos       = sdkerrors.Register(ModuleName, 1115, "cannot get all todos: %s")
	ErrCannotDeleteTodo        = sdkerrors.Register(ModuleName, 1116, "cannot delete todo: %s")
	ErrBlackCannotPay          = sdkerrors.Register(ModuleName, 1117, "black cannot pay the wager")
	ErrRedCannotPay            = sdkerrors.Register(ModuleName, 1118, "red cannot pay the wager")
	ErrNothingToPay            = sdkerrors.Register(ModuleName, 1119, "there is nothing to pay, should not have been called")
	ErrCannotRefundWager       = sdkerrors.Register(ModuleName, 1120, "cannot refund wager to: %s")
	ErrCannotPayWinnings       = sdkerrors.Register(ModuleName, 1121, "cannot pay winnings to winner: %s")
	ErrNotInRefundState        = sdkerrors.Register(ModuleName, 1122, "game is not in a state to refund, move count: %d")
)
